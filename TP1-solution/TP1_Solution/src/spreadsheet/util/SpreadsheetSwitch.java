...
public class SpreadsheetSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SpreadsheetPackage.EXPRESSION: {
				Expression expression = (Expression)theEObject;
				T result = caseExpression(expression);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SpreadsheetPackage.BIN_EXPRESSION: {
			...
			case SpreadsheetPackage.CELL_REF: {
				CellRef cellRef = (CellRef)theEObject;
				T result = caseCellRef(cellRef);
				if (result == null) result = caseExpression(cellRef);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SpreadsheetPackage.TABLEUR: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Cell Ref</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Cell Ref</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCellRef(CellRef object) {
		return null;
	}
