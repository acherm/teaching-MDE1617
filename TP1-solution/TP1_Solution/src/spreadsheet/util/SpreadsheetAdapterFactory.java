...
public class SpreadsheetAdapterFactory extends AdapterFactoryImpl {
	...
	protected SpreadsheetSwitch<Adapter> modelSwitch =
		new SpreadsheetSwitch<Adapter>() {
			...
			@Override
			public Adapter caseCellRef(CellRef object) {
				return createCellRefAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link spreadsheet.Cell <em>Cell</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link spreadsheet.Expression <em>Expression</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link spreadsheet.BinExpression <em>Bin Expression</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link spreadsheet.Value <em>Value</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link spreadsheet.CellRef <em>Cell Ref</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createCellRefAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link spreadsheet.Tableur <em>Tableur</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
